...
class SoBillingTracking(Base):
    __tablename__ = "so_billing_tracking"
    ...
    so_line_id: Mapped[UUID] = mapped_column(PG_UUID(as_uuid=True), ForeignKey("sales_order_lines.id"))
